<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="赛项名称" prop="saixiangmingcheng">
          <el-input v-model="ruleForm.saixiangmingcheng" 
              placeholder="赛项名称" clearable  :readonly="ro.saixiangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="赛项名称" prop="saixiangmingcheng">
              <el-input v-model="ruleForm.saixiangmingcheng" 
                placeholder="赛项名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.jibie"
                placeholder="级别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="参加人数" prop="canjiarenshu">
          <el-input v-model="ruleForm.canjiarenshu" 
              placeholder="参加人数" clearable  :readonly="ro.canjiarenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="参加人数" prop="canjiarenshu">
              <el-input v-model="ruleForm.canjiarenshu" 
                placeholder="参加人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="报名费用" prop="baomingfeiyong">
              <el-input v-model="ruleForm.baomingfeiyong" 
                placeholder="报名费用" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="截至日期" prop="jiezhiriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiezhiriqi" label="截至日期" prop="jiezhiriqi">
              <el-input v-model="ruleForm.jiezhiriqi" 
                placeholder="截至日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="赛项内容" prop="saixiangneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="赛项内容"
                  v-model="ruleForm.saixiangneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.saixiangneirong" label="赛项内容" prop="saixiangneirong">
                    <span>{{ruleForm.saixiangneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	saixiangmingcheng : false,
	leixing : false,
	bisaididian : false,
	saixiangneirong : false,
	jibie : false,
	canjiarenshu : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='saixiangmingcheng'){
            this.ruleForm.saixiangmingcheng = obj[o];
	    this.ro.saixiangmingcheng = true;
            continue;
          }
	            	            if(o=='leixing'){
	    ...
	    this.ro.bisaididian = true;
            continue;
	            	            ...
	            	            if(o=='saixiangneirong'){
            this.ruleForm.saixiangneirong = obj[o];
	    this.ro.saixiangneirong = true;
            continue;
          }
	            	            if(o=='jibie'){
	    ...
	    this.ro.jibie = true;
            continue;
	            	            ...
	            	            if(o=='canjiarenshu'){
            this.ruleForm.canjiarenshu = obj[o];
	    this.ro.canjiarenshu = true;
            continue;
          }
	            	            if(o=='baomingfeiyong'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.leixingOptions = "团队赛,个人赛".split(',')
                                                                            this.jibieOptions = "初赛,复赛,决赛".split(',')
                                                                                                                      },
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
        url: `saixiangxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springbootpx13e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `saixiangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.saixiangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
